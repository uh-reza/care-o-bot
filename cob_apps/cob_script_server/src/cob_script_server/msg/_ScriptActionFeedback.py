"""autogenerated by genmsg_py from ScriptActionFeedback.msg. Do not edit."""
...
class ScriptActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_script_server/ScriptFeedback']
