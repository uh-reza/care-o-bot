"""autogenerated by genmsg_py from StateActionFeedback.msg. Do not edit."""
...
class StateActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_script_server/StateFeedback']
