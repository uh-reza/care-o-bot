"""autogenerated by genmsg_py from SayActionResult.msg. Do not edit."""
...
class SayActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_sound/SayResult']
