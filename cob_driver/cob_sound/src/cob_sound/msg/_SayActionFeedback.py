"""autogenerated by genmsg_py from SayActionFeedback.msg. Do not edit."""
...
class SayActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_sound/SayFeedback']
