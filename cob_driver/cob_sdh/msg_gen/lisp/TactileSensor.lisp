...
(cl:defclass <TactileSensor> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tactile_matrix
    ...
    :type (cl:vector cob_sdh-msg:TactileMatrix)
   :initform (cl:make-array 0 :element-type 'cob_sdh-msg:TactileMatrix :initial-element (cl:make-instance 'cob_sdh-msg:TactileMatrix))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TactileSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TactileSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_sdh-msg:<TactileSensor> is deprecated: use cob_sdh-msg:TactileSensor instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TactileSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:header-val is deprecated.  Use cob_sdh-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'tactile_matrix-val :lambda-list '(m))
(cl:defmethod tactile_matrix-val ((m <TactileSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:tactile_matrix-val is deprecated.  Use cob_sdh-msg:tactile_matrix instead.")
  (tactile_matrix m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TactileSensor>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tactile_matrix)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_sdh-msg:TactileMatrix))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TactileSensor>)))
  ...
  (cl:format cl:nil "#tactile sensor data in 2D grid~%Header header~%cob_sdh/TactileMatrix[] tactile_matrix~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: cob_sdh/TactileMatrix~%uint32 matrix_id~%int16 cells_x~%int16 cells_y~%int16[] tactile_array~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TactileSensor)))
  "Returns full string definition for message of type 'TactileSensor"
  (cl:format cl:nil "#tactile sensor data in 2D grid~%Header header~%cob_sdh/TactileMatrix[] tactile_matrix~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: cob_sdh/TactileMatrix~%uint32 matrix_id~%int16 cells_x~%int16 cells_y~%int16[] tactile_array~%~%~%"))
