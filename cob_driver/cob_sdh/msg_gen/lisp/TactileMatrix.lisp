...
(cl:defmethod cl:initialize-instance :after ((m <TactileMatrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TactileMatrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_sdh-msg:<TactileMatrix> is deprecated: use cob_sdh-msg:TactileMatrix instead.")))

(cl:ensure-generic-function 'matrix_id-val :lambda-list '(m))
(cl:defmethod matrix_id-val ((m <TactileMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:matrix_id-val is deprecated.  Use cob_sdh-msg:matrix_id instead.")
  (matrix_id m))

(cl:ensure-generic-function 'cells_x-val :lambda-list '(m))
(cl:defmethod cells_x-val ((m <TactileMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:cells_x-val is deprecated.  Use cob_sdh-msg:cells_x instead.")
  (cells_x m))

(cl:ensure-generic-function 'cells_y-val :lambda-list '(m))
(cl:defmethod cells_y-val ((m <TactileMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:cells_y-val is deprecated.  Use cob_sdh-msg:cells_y instead.")
  (cells_y m))

(cl:ensure-generic-function 'tactile_array-val :lambda-list '(m))
(cl:defmethod tactile_array-val ((m <TactileMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_sdh-msg:tactile_array-val is deprecated.  Use cob_sdh-msg:tactile_array instead.")
  (tactile_array m))
