...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_srvs-srv:<GetCameraInfo-request> is deprecated: use cob_srvs-srv:GetCameraInfo-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetCameraInfo-request>)))
  ...
  "8e70c52718e2aaa277f5e07dfe36bd61")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetCameraInfo-request)))
  "Returns md5sum for a message object of type 'GetCameraInfo-request"
  "8e70c52718e2aaa277f5e07dfe36bd61")
...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_srvs-srv:<GetCameraInfo-response> is deprecated: use cob_srvs-srv:GetCameraInfo-response instead.")))

(cl:ensure-generic-function 'cameraInfo-val :lambda-list '(m))
(cl:defmethod cameraInfo-val ((m <GetCameraInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_srvs-srv:cameraInfo-val is deprecated.  Use cob_srvs-srv:cameraInfo instead.")
  (cameraInfo m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetCameraInfo-response>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'cameraInfo) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetCameraInfo-response>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'cameraInfo) istream)
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCameraInfo-response>)))
  ...
  "cob_srvs/GetCameraInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCameraInfo-response)))
  "Returns string type for a service object of type 'GetCameraInfo-response"
  "cob_srvs/GetCameraInfoResponse")
