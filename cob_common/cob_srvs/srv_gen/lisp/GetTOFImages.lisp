...
(cl:defmethod cl:initialize-instance :after ((m <GetTOFImages-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTOFImages-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_srvs-srv:<GetTOFImages-request> is deprecated: use cob_srvs-srv:GetTOFImages-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetTOFImages-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTOFImages-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_srvs-srv:<GetTOFImages-response> is deprecated: use cob_srvs-srv:GetTOFImages-response instead.")))

(cl:ensure-generic-function 'greyImage-val :lambda-list '(m))
(cl:defmethod greyImage-val ((m <GetTOFImages-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_srvs-srv:greyImage-val is deprecated.  Use cob_srvs-srv:greyImage instead.")
  (greyImage m))
