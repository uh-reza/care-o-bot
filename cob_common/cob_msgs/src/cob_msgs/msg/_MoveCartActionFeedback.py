"""autogenerated by genmsg_py from MoveCartActionFeedback.msg. Do not edit."""
...
class MoveCartActionFeedback(roslib.message.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "cob_msgs/MoveCartActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cob_msgs/MoveCartFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveCartActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_msgs.msg.MoveCartFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_msgs.msg.MoveCartFeedback()
