...
class Detection(roslib.message.Message):
  _md5sum = "fc0d613513a2fabeb1eebd8491c53e68"
  _type = "cob_msgs/Detection"
...
"""
  __slots__ = ['header','label','detector','score','mask','pose']
  _slot_types = ['Header','string','string','float32','cob_msgs/Mask','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,label,detector,score,mask,pose
