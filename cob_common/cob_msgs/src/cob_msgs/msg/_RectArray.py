"""autogenerated by genmsg_py from RectArray.msg. Do not edit."""
...
class RectArray(roslib.message.Message):
  _md5sum = "e83b38fbaea3a641fa77f009f9bf492e"
  _type = "cob_msgs/RectArray"
...
"""
  ...
  _slot_types = ['Header','cob_msgs/Rect[]']
