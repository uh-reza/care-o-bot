"""autogenerated by genmsg_py from MoveCartAction.msg. Do not edit."""
...
class MoveCartAction(roslib.message.Message):
  _md5sum = "69d4b96f9af8157defa4ae75671a3b5b"
  _type = "cob_msgs/MoveCartAction"
...
"""
  ...
  _slot_types = ['cob_msgs/MoveCartActionGoal','cob_msgs/MoveCartActionResult','cob_msgs/MoveCartActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveCartAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_msgs.msg.MoveCartActionGoal()
      if self.action_result is None:
        self.action_result = cob_msgs.msg.MoveCartActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_msgs.msg.MoveCartActionFeedback()
    else:
      self.action_goal = cob_msgs.msg.MoveCartActionGoal()
      self.action_result = cob_msgs.msg.MoveCartActionResult()
      self.action_feedback = cob_msgs.msg.MoveCartActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.goal_pose.header.seq, _x.action_goal.goal.goal_pose.header.stamp.secs, _x.action_goal.goal.goal_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goal_pose.header.seq, _x.action_goal.goal.goal_pose.header.stamp.secs, _x.action_goal.goal.goal_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_goal.goal.goal_pose.pose.position.x, _x.action_goal.goal.goal_pose.pose.position.y, _x.action_goal.goal.goal_pose.pose.position.z, _x.action_goal.goal.goal_pose.pose.orientation.x, _x.action_goal.goal.goal_pose.pose.orientation.y, _x.action_goal.goal.goal_pose.pose.orientation.z, _x.action_goal.goal.goal_pose.pose.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
