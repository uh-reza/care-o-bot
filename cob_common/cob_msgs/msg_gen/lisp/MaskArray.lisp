...
(cl:defclass <MaskArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (masks
    :reader masks
    :initarg :masks
    :type (cl:vector cob_msgs-msg:Mask)
   :initform (cl:make-array 0 :element-type 'cob_msgs-msg:Mask :initial-element (cl:make-instance 'cob_msgs-msg:Mask))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MaskArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MaskArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<MaskArray> is deprecated: use cob_msgs-msg:MaskArray instead.")))
...
(cl:defmethod masks-val ((m <MaskArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:masks-val is deprecated.  Use cob_msgs-msg:masks instead.")
  (masks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MaskArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'masks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_msgs-msg:Mask))
