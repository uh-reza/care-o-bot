...
(cl:defclass <RectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rects
    :reader rects
    :initarg :rects
    :type (cl:vector cob_msgs-msg:Rect)
   :initform (cl:make-array 0 :element-type 'cob_msgs-msg:Rect :initial-element (cl:make-instance 'cob_msgs-msg:Rect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<RectArray> is deprecated: use cob_msgs-msg:RectArray instead.")))
...
(cl:defmethod rects-val ((m <RectArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:rects-val is deprecated.  Use cob_msgs-msg:rects instead.")
  (rects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_msgs-msg:Rect))
