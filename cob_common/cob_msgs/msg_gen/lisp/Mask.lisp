...
(cl:defclass <Mask> (roslisp-msg-protocol:ros-message)
  ((roi
    :reader roi
    :initarg :roi
    :type cob_msgs-msg:Rect
    :initform (cl:make-instance 'cob_msgs-msg:Rect))
   (mask
    :reader mask
    :initarg :mask
...
(cl:defmethod cl:initialize-instance :after ((m <Mask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<Mask> is deprecated: use cob_msgs-msg:Mask instead.")))

(cl:ensure-generic-function 'roi-val :lambda-list '(m))
(cl:defmethod roi-val ((m <Mask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:roi-val is deprecated.  Use cob_msgs-msg:roi instead.")
  (roi m))
